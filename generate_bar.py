...
# Baselines: muted blue-grey family; FinMini: maize
BAR_COLORS  = ["#8AAFC9", "#5580A0", "#2D5F82", UMICH_MAIZE]
EDGE_COLORS = ["#6090B0", "#3A6482", "#1A4560", UMICH_BLUE]
...
for i, (model, color, edge) in enumerate(zip(MODEL_NAMES, BAR_COLORS, EDGE_COLORS)):
    ...
    for bar, v in zip(bars, accs):
        ax.text(
            ...
            ha="center", va="bottom",
            fontsize=7.8,
            color=UMICH_BLUE if i < 3 else "#7a5c00",
            fontweight="bold" if i == 3 else "normal",
        )

# Bracket annotation "Best" over FinMini bars
